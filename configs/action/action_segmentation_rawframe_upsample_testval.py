...
test = dict(
    data=dict(
        dataset=dict(
            ...
            root=dataset_root,
            nclasses=nclasses,
            img_prefix='ori_data/images/test',
            ann_file='annotations_thumos14_long_val.json',
            multi_label=multi_label,
        ),
...
train = dict(
    ...
    criterion=dict(type='BCEWithLogitsLoss', ignore_index=ignore_label, reduction='sum'),
